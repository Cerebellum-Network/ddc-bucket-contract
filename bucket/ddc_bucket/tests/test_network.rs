...
// //     let mut storage_nodes: Vec<TestStorage> = node_specs
// //         .iter()
// //         .map(|spec| TestStorage::new(&mut contract, spec.0, manager_id, spec.1))
// //         .collect();

// //     assert_ne!(
// //         storage_nodes[0].node.url, storage_nodes[1].node.url,
// //         "nodes must have different URLs"
// //     );
...
// //             storage_nodes[node_i]
// //                 .handle_request(&contract, &storage_requests[request_i])
// //                 .unwrap();
// //         }
// //     };
...
// //     execute_action(
// //         Action {
// //             routing_key: routing0,
// //             data: "data in shard 0".to_string(),
// //             op: Op::Write,
// //         },
// //         &[0, 1, 2],
// //     );
...
// //             data: "data in shard 1".to_string(),
// //             op: Op::Write,
// //         },
// //         &[1, 2, 3],
// //     );
// //     execute_action(
// //         Action {
// //             routing_key: routing4,
// //             data: "data in shard 4".to_string(),
// //             op: Op::Write,
// //         },
// //         &[4, 5, 0],
// //     );
